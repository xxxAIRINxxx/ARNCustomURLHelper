...
// ARNCustomURLHelper
#define COCOAPODS_POD_AVAILABLE_ARNCustomURLHelper
#define COCOAPODS_VERSION_MAJOR_ARNCustomURLHelper 0
#define COCOAPODS_VERSION_MINOR_ARNCustomURLHelper 1
#define COCOAPODS_VERSION_PATCH_ARNCustomURLHelper 0
